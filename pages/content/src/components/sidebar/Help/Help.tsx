          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              <Typography variant="body" className="text-sm">
                MCP SuperAssistant is a Chrome extension that bridges the Model Context Protocol (MCP) with web-based AI
      ...
      content: (
        <div className="space-y-4">
          <Card>
            ...
            <CardContent className="space-y-2">
              <Typography variant="body" className="text-sm">
                To connect to local MCP servers, you need to run the MCP SuperAssistant Proxy. This proxy bridges the
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              ...
              <div className="flex flex-col gap-3 mt-4">
                <a
                  href="https://github.com/srbhptl39/MCP-SuperAssistant/issues"
                  target="_blank"
                  rel="noopener noreferrer"
